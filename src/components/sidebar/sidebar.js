...
const nav_items = [
    {
        section: 'Management',
        items: [
            { id: 'workers', label: 'Workers', path: '/admin/workers', ready: true },
            { id: 'requests', label: 'Requests', path: '/admin/requests', ready: true },
            { id: 'messaging', label: 'Messaging', path: '/admin/messaging', ready: true },
            { id: 'residents', label: 'Residents', path: '/admin/residents', ready: true },
        ],
    },
    {
        section: 'Insights',
        items: [
            {
                ...
                label: 'Analytics',
                sub_items: [
                    { id: 'category_report', label: 'Category Report', path: '/admin/analytics/category-report', ready: true },
                    { id: 'worker_performance', label: 'Worker Performance', path: '/admin/analytics/performance', ready: false },
                    { id: 'satisfaction', label: 'Resident Satisfaction', path: '/admin/analytics/satisfaction', ready: false },
                    { id: 'custom_reports', label: 'Custom Reports', path: '/admin/analytics/custom', ready: false },
                ],
            },
            { id: 'settings', label: 'Settings', path: '/admin/settings', ready: true },
        ],
    },
]
