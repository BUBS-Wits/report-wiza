  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      try {
        ...
        const { stats, total_requests: total } = await fetch_report_data()
            ...
            <div>
              ...
              <p className="report_subtitle">
                ...
                <span className="report_generated">
                  Generated{' '}
                  {generated_at.toLocaleDateString('en-ZA', {
                    day: 'numeric',
                    month: 'short',
                    year: 'numeric',
                    hour: '2-digit',
      ...
      <main className="report_main">
        ...
        <section className="summary_grid">
          ...
          <div className="summary_card summary_card_blue">
            <span className="summary_value">{summary?.total_pending ?? 0}</span>
            <span className="summary_label">Pending</span>
          </div>

          <div className="summary_card summary_card_green">
            <span className="summary_value">{summary?.total_resolved ?? 0}</span>
            <span className="summary_label">Resolved</span>
          </div>

          <div className="summary_card summary_card_amber">
            <span className="summary_value">
              {summary?.overall_avg_hours !== null && summary?.overall_avg_hours !== undefined
                ? format_resolution_time(summary.overall_avg_hours)
                : '—'}
            </span>
        ...
        <section className="report_section">
          ...
          <div className="bar_chart">
              ...
              <div key={row.category} className="bar_row">
                ...
                <div className="bar_track">
                  <div
                    ...
                    style={{ width: `${(row.pending / max_total) * 100}%` }}
            ...
            <div className="bar_legend">
              <span className="legend_dot legend_dot_open" /> Pending
        ...
        <section className="report_section">
            ...
            <table className="report_table">
              ...
              <tbody>
                {report_data.map((row) => {
                  ...
                  return (
                    <tr key={row.category} className={row.pending > 5 ? 'row_warn' : ''}>
                      <td>
                      ...
                      <td className="td_num td_open">{row.pending}</td>
          ...
          <p className="table_footnote">
            ⚑ Rows with more than 5 pending requests are highlighted. Avg resolution time is
