    ...
    <Navbar />
      ...
      <section className="landing_hero">
        ...
        <div className="hero_content">
          <div className="hero_badge">Municipal Service Delivery Portal</div>
          <h1 className="hero_heading">
            Your Ward.<br />
            <span className="hero_heading_accent">Your Voice.</span><br />
            Your City.
          </h1>
          <p className="hero_subtext">
            Report potholes, water outages, electricity faults and more —
            directly to your municipality. Track every request in real time.
          </p>
      ...
      <section className="landing_features">
        ...
        <div className="features_grid">
          <div className="feature_card">
            ...
            <p>Pin your location, choose a category, and describe the issue. Attach a photo for faster resolution.</p>
          </div>
          <div className="feature_card">
            <div className="feature_icon">🔔</div>
            <h3>Get Notified</h3>
            <p>Receive real-time updates as your request moves from open to in progress to resolved.</p>
          </div>
          <div className="feature_card">
            <div className="feature_icon">🗺️</div>
            <h3>Track on the Map</h3>
            <p>View all requests in your ward on a live map with official South African ward boundaries.</p>
          </div>
          <div className="feature_card">
            <div className="feature_icon">⭐</div>
            <h3>Rate the Service</h3>
            <p>Once resolved, rate your experience and help your municipality improve service delivery.</p>
          </div>
        </div>
      </section>
