    ...
    <div className="public_dashboard">
      <header className="dashboard_header">
        ...
        <p className="dashboard_intro">
          Browse open and recently resolved municipal service requests in your
          community. This dashboard is publicly accessible and read-only.
        </p>
      </header>
      ...
      <section className="map_section">
        ...
        <div className="map_placeholder">
          ...
          <span>
            This public dashboard will later display issue locations on a ward
            map.
          </span>
        </div>
      </section>
