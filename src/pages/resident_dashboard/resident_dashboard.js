...
export default function ResidentDashboard() {
    ...
    return (
        <div className="rd-page">
                ...
                <div className="rd-topbar-right">
                    ...
                    >
                        <svg viewBox="0 0 16 16" fill="none" aria-hidden="true">
                            ...
                            <path d="M11 11l3-3-3-3M14 8H6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
            ...
            <div className={`rd-layout ${selected_id ? 'rd-layout--detail-open' : ''}`}>
        ...
        <div className="rd-detail">
            <div className="rd-detail-header">
                <div className="rd-detail-header-left">
                    ...
                    <button className="rd-back-btn" onClick={on_back} aria-label="Back to requests">
                        <svg viewBox="0 0 16 16" fill="none" aria-hidden="true" style={{ width: '18px', height: '18px' }}>
