...
describe('Admin Messaging Service', () => {
    ...
    describe('admin_toggle_thread_messaging', () => {
        test('updates Firestore and invalidates cache', async () => {
            await admin_toggle_thread_messaging('req_123', false, 'admin_99', 'Spam')
    ...
    describe('subscribe_to_thread_messages', () => {
        test('uses the OR query correctly to tolerate different field names', () => {
            ...
            subscribe_to_thread_messages('req_123', mock_on_update, mock_on_error)
                ...
                docs: [
                    {
                        ...
                        data: () => ({
                            ...
                            read: true,
                            sent_at: new Date('2025-05-12T10:00:00Z').toISOString()
                        })
                    },
                    {
                        id: 'msg2',
                        data: () => ({
                            ...
                            sent_at: new Date('2025-05-12T10:05:00Z').toISOString()
                        })
                    }
                ]
            }
