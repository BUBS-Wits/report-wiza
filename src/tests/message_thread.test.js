...
const mockMessages = [
    { id: 'msg_1', sender_uid: 'worker_1', text: 'On my way!', created_at: new Date() },
    { id: 'msg_2', sender_uid: 'user_1', text: 'Thanks!', created_at: new Date() },
];
...
describe('MessageThread Component', () => {
    ...
    test('marks messages as read upon loading', async () => {
        ...
        await waitFor(() => {
            expect(mark_messages_read).toHaveBeenCalledWith(expect.any(Array), 'user_1');
        });
    });
    ...
    test('allows sending a new message', async () => {
        ...
        await waitFor(() => {
            expect(send_message).toHaveBeenCalledWith(expect.objectContaining({
                request_id: 'req_123',
                sender_uid: 'user_1',
                text: 'Is it fixed?'
            }));
            ...
            expect(notify_new_message).toHaveBeenCalledWith(expect.objectContaining({
                request_id: 'req_123',
