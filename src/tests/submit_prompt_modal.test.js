...
// Mock CSS
jest.mock('../components/submit_prompt_modal/submit_prompt_modal.css', () => ({}));
...
describe('SubmitPromptModal Component', () => {
    ...
    test('navigates to /login and closes modal when "Create Account / Sign In" is clicked', () => {
        ...
        const createBtn = screen.getByRole('button', { name: /Create Account \/ Sign In/i });
    ...
    test('calls on_continue when "Continue without an account" is clicked', () => {
        ...
        const continueBtn = screen.getByRole('button', { name: /Continue without an account/i });
